# Ordering Instructions on [JLCPCB](https://jlcpcb.com/) — SMD variant

This is the surface-mount variant, designed to be **fully assembled** by JLCPCB using
parts from their stock (cheapest option for a finished board).
...
* **BOM** + **Component Positions (CPL)** — *File → Fabrication Outputs* (or the
  Fabrication Toolkit plugin)

Pre-built bundles are also attached to the [releases page](https://github.com/alvarop/usb_c_cable_tester/releases/).
